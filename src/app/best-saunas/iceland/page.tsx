...
export default function IcelandSaunasPage() {
  const jsonLd = {
    ...
    mainEntityOfPage: "https://www.finnishsaunaguide.com/best-saunas/iceland",
  };
  ...
  return (
    <>
      ...
      <div className="relative w-full h-[50vh] min-h-[400px] mb-10">
        <Image
          src="/images/frost-birch-trees-winter.jpg"
          alt="Frost-covered birch trees against a deep blue winter sky"
          fill
          priority
